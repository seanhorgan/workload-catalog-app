...
export const workloads: Workload[] = [
  ...
  },
  {
    ...
    variables: {
      isl: "55000, 100,000 (median, max)",
      islNewPerTurn: "2000",
      osl: "800, 4000 (median, max)",
  ...
  },
  {
    ...
    variables: {
      isl: "45000, 100,000 (median, max)",
      islNewPerTurn: "3000",
      osl: "300, 3000 (median, max)",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/kubernetes-sigs/inference-perf/tree/main/workload-catalog/deep-thinking",
    variables: {
  ...
  },
  {
    ...
    githubUrl: "https://github.com/kubernetes-sigs/inference-perf/tree/main/workload-catalog/batch-summarization",
    variables: {
      isl: "15000, 50000 (median, max)",
      islNewPerTurn: "-",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/kubernetes-sigs/inference-perf/tree/main/workload-catalog/synthetic-data-generation",
    variables: {
      isl: "32000, 262000 (median, max)",
      islNewPerTurn: "-",
      osl: "2000, 8000 (median, max)",
      distribution: "Log-Normal",
      multiTurn: "No",
      turnsMean: "1",
      systemPrompt: "4000",
